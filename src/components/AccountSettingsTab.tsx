            ...
            <button
              ...
              onClick={() => {
                const dbData = {
                  ...
                  users,
                  masterData: {
                    jenisAset: JENIS_ASET_MAP,
                    teritori: JENIS_ASET_MAP, TERITORI_MAP,
              ...
              {role === 'KOORDINATOR_TIM' && (
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2.5 animate-fade-in">
                  ...
                  <select
                    ...
                    className="w-full text-xs font-semibold text-slate-700 bg-white border border-slate-200 rounded-lg px-2.5 py-2.5 focus:outline-none focus:ring-1 focus:ring-primary-500 cursor-pointer disabled:bg-slate-100 disabled:cursor-not-allowed"
                  >
                ...
                <div className="border border-slate-200 rounded-xl overflow-x-auto bg-white shadow-sm">
                  <table className="min-w-full divide-y divide-slate-100 text-left text-xs">
                    <thead className="bg-slate-50 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
                      <tr>
                        <th className="px-5 py-3 w-[45%] text-left">Nama / Username / Email</th>
                            ...
                            <td className="px-5 py-3">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0 text-left">
                                  ...
                                  <span className="font-mono text-slate-400 text-[10px] truncate block max-w-[180px] sm:max-w-none">@{u.username || 'none'} &bull; {u.email}</span>
                                </div>
                              </div>
                            </td>
